...
class Email():
    ...
    def _attach_file(self,att_file):
        ...
        att = MIMEMultipart(f.read(),'plain','utf-8')  #构造附件
...
e = Email(server='smtp.126.com',sender='zwh2537@126.com',password='abc19891969',receiver='374448636@qq.com',title='CESHI',message='zengwenhai')
e.send()
